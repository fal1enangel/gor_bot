...
bot = telebot.TeleBot('5608475022:AAHwmLXcZriEm1YpJWrmVATB-sR9z0IQ0Gk')
...
first = ['Думаем и пересчитываем деньги чаще – это приманит к нам финансовую энергию.',
         ...
         'Сдвинуться с места заставляет лишь острая необходимость или «волшебный пинок», '
         'если же их нет, можно весь день провести за перекладыванием с места на место бумажек,'
         ' увлекательными беседами ни о чем или томным созерцанием действительности за окном.'
    , 'Гороскоп советует дать себе отдых: если есть возможность – отложите дела.',
         'Сегодня Луна в Тельце, энергетика довольно тяжелая.',
         'Если вы своевременно найдете недостатки в своей работе, то еще есть время исправ'
         'ить их без материальных потерь для себя.']
...
c = ['Лучше синица в руках, чем в каком-нибудь другом месте.', 'Индюк тоже думал, что купает'
                                                               'ся, пока вода не закипела.',
...
#отправление приветственного сообщения
def get_text_messages(message):
    if message.text == "Привет":
        bot.send_message(message.from_user.id,
                         "Привет, сейчас я расскажу тебе гороскоп на сегодня. Если не хочешь"
                         " гороскоп, то напиши пословица.")
    #вывод кнопок при запросе гороскоп
